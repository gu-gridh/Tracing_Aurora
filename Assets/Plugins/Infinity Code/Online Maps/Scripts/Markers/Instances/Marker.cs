...
namespace OnlineMaps
{
    ...
    public abstract class Marker: IInteractiveElement, IDataContainer
    {
        ...
        protected IInteractiveElementManager _manager;
        ...
        public virtual bool inMapView
        {
            get
            {
                ...
                return map.view.rect.ContainsWrapped(location);
            }
        }
        ...
        public bool isDraggable
        {
            ...
            set
            {
                ...
                if (value) OnPress += OnMarkerPress;
        ...
        /// Reference to map
        /// </summary>
        public Map map => _manager == null ? Map.instance : _manager.map;
        ...
        public TilePoint GetTilePosition() => location.ToTile(map);
        ...
        /// <returns>Tile position</returns>
        public TilePoint GetTilePosition(int zoom) => location.ToTile(map, zoom);

        /// <summary>
        /// Checks if the marker is in the current map view
        /// </summary>
        /// <returns>True - in map view. False - outside map view</returns>
        public bool InMapView() => map.view.Contains(location);
        ...
        public void LookToLocation(double longitude, double latitude) => LookToLocation(new GeoPoint(longitude, latitude));

        private void OnMarkerPress(Marker marker) => map.control.marker2DManager.dragMarker = this;

        /// <summary>
        /// Makes the marker draggable or un draggable
        /// </summary>
        /// <param name="value">True - set draggable, false - unset draggable</param>
        public void SetDraggable(bool value = true) => isDraggable = value;
