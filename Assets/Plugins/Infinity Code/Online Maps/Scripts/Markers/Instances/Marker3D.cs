...
namespace OnlineMaps
{
    ...
    public class Marker3D : Marker
    {
        ...
        /// Type of altitude
        /// </summary>
        public AltitudeType altitudeType = AltitudeType.relative;
        ...
        public new Marker3DManager manager
        {
            get => _manager != null? (Marker3DManager)_manager: Marker3DManager.instance;
            set => _manager = value;
        }
        ...
        public void Update(Bounds bounds, GeoRect rect, int zoom, TileRect tileRect, float bestYScale)
        {
            ...
            if (altitudeType == AltitudeType.absolute || altitude != 0)
            {
