...
namespace OnlineMaps
{
    ...
    public class JSONObject : JSONItem
    {
        ...
        /// <summary>
        /// Constructor with pairs of key and value
        /// </summary>
        /// <param name="pairs">Pairs of key and value</param>
        public JSONObject(params (string key, string value)[] pairs)
        {
            _table = new Dictionary<string, JSONItem>();
            foreach ((string key, string value) in pairs)
            {
                _table[key] = new JSONValue(value);
            }
        }
        ...
        /// <summary>
        /// Creates and adds an array to the dictionary with the specified key.
        /// </summary>
        /// <param name="name">The key of the array to create and add.</param>
        /// <returns>The created JSONArray.</returns>
