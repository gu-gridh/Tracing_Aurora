...
namespace OnlineMaps
{
    ...
    public class JSONArray : JSONItem
    {
        ...
        /// </summary>
        /// <param name="item">Element</param>
        public void Add(JSONValue item) => Add(item as JSONItem);
        ...
        public void AddRange(JSONItem collection) => AddRange(collection as JSONArray);
        ...
        public override IEnumerator<JSONItem> GetEnumerator() => array.GetEnumerator();
        ...
        public static JSONArray ParseArray(string json) => JSON.Parse(json) as JSONArray;
        ...
        {
            return ReflectionHelper.IsValueType(type) ? Activator.CreateInstance(type) : null;
        }
    }
}