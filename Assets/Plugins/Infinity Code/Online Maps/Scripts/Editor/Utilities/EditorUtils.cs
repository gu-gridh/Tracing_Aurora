...
namespace OnlineMaps.Editors
{
    public static class EditorUtils
    {
        ...
        public static void CheckMarkerTextureImporter(Texture2D texture)
        {
            ...
            string textureFilename = EditorCompatibility.GetAssetPath(texture.GetInstanceID());
        ...
        public static EventSystem GetEventSystem()
        {
            ...
            if (!eventSystem)
            {
                ...
                if (assembly != null)
                {
                    Type t = assembly.GetType("UnityEngine.InputSystem.UI.InputSystemUIInputModule");
                    if (t != null) type = t;
                }
#endif
                es.AddComponent(type);
            }
