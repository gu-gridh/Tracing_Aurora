...
namespace OnlineMaps
{
    ...
    public abstract class Tile: IDataContainer
    {
        ...
        /// <summary>
        /// The Mercator coordinates of the center point of the tile.
        /// </summary>
        public MercatorPoint centerMercator { get; private set; }
        ...
        /// </summary>
        public GeoPoint globalPosition { get; private set; }
        ...
        public Tile(int x, int y, int zoom, Map map, bool isMapTile = true)
        {
            ...
            double mx, my;
            Projection.TileToMercator(x + 0.5, y + 0.5, zoom, out mx, out my);
            centerMercator = new MercatorPoint(mx, my);
