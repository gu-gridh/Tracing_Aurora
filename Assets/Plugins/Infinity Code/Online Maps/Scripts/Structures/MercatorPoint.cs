...
namespace OnlineMaps
{
    ...
    public struct MercatorPoint
    {
        ...
        public static MercatorPoint LerpWrapped(MercatorPoint p1, MercatorPoint p2, double d)
        {
            if (p2.x < p1.x) p2.x += 1;
            else if (p2.x - p1.x > 1) p2.x -= 1;
            return new MercatorPoint(p1.x + (p2.x - p1.x) * d, p1.y + (p2.y - p1.y) * d);
        }
        ...
        public GeoPoint ToLocation(Map map) => map.view.projection.MercatorToLocation(x, y);
        ...
        /// <returns>A GeoPoint representing the geographic coordinates.</returns>
        public GeoPoint ToLocation(Projection projection) => projection.MercatorToLocation(x, y);

        /// <summary>
        /// Converts the Mercator point to meters.
        /// </summary>
        /// <returns>A meters in Web Mercator projection.</returns>
        public Vector2d ToMeters() => new Vector2d(x * Constants.EarthRadiusMeters, y * Constants.EarthRadiusMeters);
        ...
        public TilePoint ToTile(int zoom) => Projection.MercatorToTile(x, y, zoom);
        ...
        public static Vector2d operator +(MercatorPoint a, MercatorPoint b) => new MercatorPoint(a.x + b.x, a.y + b.y);
        ...
        /// <summary>
        /// Multiplies the coordinates of the specified MercatorPoint by a scalar value.
        /// </summary>
        /// <param name="a">The MercatorPoint to multiply.</param>
        /// <param name="b">The scalar value to multiply by.</param>
        /// <returns>A Vector2d representing scaled coordinates.</returns>
        public static Vector2d operator *(MercatorPoint a, double b) => new Vector2d(a.x * b, a.y * b);
        ...
        /// <returns>A Vector2d representing divided coordinates.</returns>
        public static Vector2d operator / (MercatorPoint a, double b)
        {
        ...
        /// <summary>
        /// Implicitly converts a MercatorPoint to a Vector2d.
        /// </summary>
        /// <param name="point">The MercatorPoint to convert.</param>
        /// <returns>A Vector2d representing the converted MercatorPoint.</returns>
        public static implicit operator Vector2d(MercatorPoint point) => new Vector2d(point.x, point.y);
        ...
        public static implicit operator MercatorPoint(Vector2d point) => new MercatorPoint(point.x, point.y);
        ...
        public static implicit operator Vector2(MercatorPoint point) => new Vector2((float)point.x, (float)point.y);
        ...
        public static implicit operator MercatorPoint(Vector2 point) => new MercatorPoint(point.x, point.y);
    }
}