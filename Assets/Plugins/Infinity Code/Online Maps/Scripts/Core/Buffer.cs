...
namespace OnlineMaps
{
    ...
    public class Buffer
    {
        ...
        private void UpdateBackBuffer()
        {
            ...
            Vector2Int pos = new Vector2Int((int)(t.x - countX / 2f), (int)(t.y - countY / 2f));
        ...
        {
            float countX = renderState.width / 2f / Constants.TileSize;
            float countY = renderState.height / 2f / Constants.TileSize;
