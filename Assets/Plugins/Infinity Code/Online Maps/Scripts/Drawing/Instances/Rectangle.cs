...
namespace OnlineMaps
{
    ...
    public class Rectangle : DrawingElement
    {
        ...
        /// <param name="size">The size of the rectangle. Geographic degree.</param>
        ...
        /// <summary>
        /// Creates a new rectangle from corner coordinates.
        /// </summary>
        /// <param name="topLeft">The coordinates of top-left corner.</param>
        /// <param name="bottomRight">The coordinates of bottom-right corner.</param>
        /// <returns>New rectangle.</returns>
        public static Rectangle FromCorners(GeoPoint topLeft, GeoPoint bottomRight)
        {
