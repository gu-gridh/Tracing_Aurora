...
namespace OnlineMapsExamples
{
    ...
    public class Marker3D_GPS_Example : MonoBehaviour
    {
        ...
        private void OnCompassChanged(float heading)
        {
            ...
            //if (markerTransform) markerTransform.localRotation = Quaternion.Euler(0, heading, 0);
            if (markerTransform) markerTransform.localRotation = Quaternion.Euler(0, heading + 180f, 0);
        }
