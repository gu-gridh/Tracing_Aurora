...
namespace OnlineMapsExamples
{
    ...
    public class JSONExample : MonoBehaviour
    {
        ...
        private void DynamicGeneration()
        {
            ...
            rootNode.Add("Hello 1", "World");
            rootNode.Add("Hello 2", new JSONValue("World"));
            rootNode.Add("Hello 3", new JSONValue("World", JSONValueType.STRING));

            // Create and add array nodes
            JSONArray children = rootNode.CreateArray("children");
